...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_LOWER] = { ENCODER_CCW_CW(KC_BRID, KC_BRIU), ENCODER_CCW_CW(QK_BACKLIGHT_DOWN, QK_BACKLIGHT_UP) },
    [_RAISE] = { ENCODER_CCW_CW(/*QK_LED_MATRIX_BRIGHTNESS_DOWN, QK_LED_MATRIX_BRIGHTNESS_UP*/_______, _______), ENCODER_CCW_CW(KC_MS_WH_RIGHT, KC_MS_WH_LEFT)},
